...
export default function ClassOf2026Page() {
  ...
  const v2Data = (v2Content as any).classOf2026
    ...
    try {
      const response = await fetch('/api/stripe', {
        ...
        body: JSON.stringify({
          ...
          campaign: 'classOf2026',
          successUrl: `${window.location.origin}/success?campaign=classOf2026&session_id={CHECKOUT_SESSION_ID}`,
          cancelUrl: `${window.location.origin}/class-of-2026`,
        }),
      })
